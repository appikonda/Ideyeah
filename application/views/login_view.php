...
<form id="loginForm" name="loginForm" method="post" action="<?php echo base_url(); ?>login/validate">
<label for="username">Username:</label> <input type="text" id="username" name="username" /><br/>
<label for="password">Password:</label> <input type="password" id="password" name="password" /><br/>
<input type="submit" id="login" name="login" value="Login" /> &nbsp; <input type="reset" value="Reset" />
</form>
<br/>
<p>Not a member? <?php echo '<a href="'.base_url().'register">Sign Up here</a>';?></p>
</fieldset>
               </div>
            </div>
