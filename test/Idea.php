...
<!-- header -->
	<header>
		<div class="wrapper">
			<nav>
				<ul id="menu">
					<li id="menu_active"><a href="index.html"><span>P</span>rofile</a></li>
					<li><a href="index.html"><span>P</span>ost Idea</a></li>
                                        <li><a href="index.html"><span>I</span>dea Stream</a></li>
                                        <li><a href="LogoutActionPage.php"><span>L</span>ogOut</a></li>
				</ul>
			</nav>
		</div>
		<h1><a href="index.html" id="logo">IdeYeah.me</a></h1>
	...
	<section id="content">
		<div class="wrapper">
			<article class="col1">
                                ...
                                <h2><span>Post Your Idea</span></h2>
				<div class="pad_left1">
					<div class="pad_left1">
						<div class="wrapper pad_top1">
                                            //Paste the logic over here                                        
